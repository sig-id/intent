                    ...
                    for t1 in t1s {
                        for t2 in t2s {
                            ...
                            composition.transitions.push(TransitionDecl {
                                ...
                                inputs: [t1.inputs.clone(), t2.inputs.clone()].concat(),
                                bindings: [t1.bindings.clone(), t2.bindings.clone()].concat(),
                                guard: merge_guards(&t1.guard, &t2.guard),
                                expects: [t1.expects.clone(), t2.expects.clone()].concat(),
                ...
                for t1 in &b1.transitions {
                    ...
                    if t1_from == s1.name && !sync_events.contains(t1.on_event.as_str()) {
                        ...
                        composition.transitions.push(TransitionDecl {
                            ...
                            bindings: t1.bindings.clone(),
                            guard: t1.guard.clone(),
                            expects: t1.expects.clone(),
                ...
                for t2 in &b2.transitions {
                    ...
                    if t2_from == s2.name && !sync_events.contains(t2.on_event.as_str()) {
                        ...
                        composition.transitions.push(TransitionDecl {
                            ...
                            inputs: t2.inputs.clone(),
                            bindings: t2.bindings.clone(),
                            guard: t2.guard.clone(),
                            expects: t2.expects.clone(),
